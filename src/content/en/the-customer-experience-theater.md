---
title: "The Customer Experience Theater"
...
Rehearsals in theater happen before the actual show, and similarly, companies must train their on-stage employees over and over to ensure the best possible performance. Training before each actual show is not enough; rehearsals must continue from time to time, away from the audience, to ensure the next show is better than the last — or, at the very least, just as impressive. One company that has excelled at this is Disney (whose employees train for 7 hours for every actual minute of customer interaction). This is mentioned in [The Experience](https://www.amazon.com/Experience-Principles-Service-Relationship-Excellence-ebook/dp/B00SZ635ZS) (page 27), a book that addresses this exact concept extensively — specifically with Disney. I recommend it.
