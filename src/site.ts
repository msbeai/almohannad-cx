...
export const T = {
  ar: {
    ...
    disclaimer: 'الآراء في منشوراتي شخصية ولا تمثل جهة عملي',
    license: 'يسمح بالاستخدام غير التجاري مع نسب العمل لصاحبه',
  ...
  en: {
    ...
    disclaimer: 'Views in my posts are my own and do not represent my employer',
    license: 'Non-commercial reuse permitted with attribution',
